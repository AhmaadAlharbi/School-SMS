                            ...
                            <div class="hs-dropdown-menu ti-dropdown-menu min-w-[10rem]"
                                ...
                                <div class="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                                    <div class="py-2 first:pt-0 last:pb-0">
                                        ...
                                        <div class="ti-drop-down-item">
                                            <ul>
                                                @php
                                                $currentLocale = LaravelLocalization::getCurrentLocale();
                                                $supportedLocales = LaravelLocalization::getSupportedLocales();
                                                $currentLocaleProperties = $supportedLocales[$currentLocale];
                                                unset($supportedLocales[$currentLocale]);

                                                // Define an array to map language codes to Font Awesome icon classes
                                                $iconClasses = [
                                                'en' => 'fas fa-flag', // English flag icon class
                                                'ar' => 'fas fa-globe', // Arabic globe icon class
                                                // You can customize the icon classes for other languages as needed
                                                ];
                                                @endphp

                                                <li class="ti-dropdown-item">
                                                    <a rel="alternate" hreflang="{{ $currentLocale }}"
                                                        href="{{ LaravelLocalization::getLocalizedURL($currentLocale, null, [], true) }}">
                                                        <div
                                                            class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                                            <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                                                <i class="{{ $iconClasses[$currentLocale] }}"></i>
                                                            </div>
                                                            <div>
                                                                <p class="text-xs font-medium">
                                                                    {{ $currentLocaleProperties['native'] }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </a>
                                                ...
                                                <li class="ti-dropdown-item">
                                                    <a rel="alternate" hreflang="{{ $localeCode }}"
                                                        ...
                                                        <div
                                                            class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                                            <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                                                <i class="{{ $iconClasses[$localeCode] }}"></i>
                                                            </div>
                                                            <div>
                                                                <p class="text-xs font-medium">
                                                                    {{ $properties['native'] }}
                                    ...
                                    <div class="py-2 first:pt-0 last:pb-0" id="allCartsContainer">
                                        <div class="ti-dropdown-item relative header-box">
                                            <a href="javascript:void(0);"
                                                ...
                                                <img loading="lazy"
                                                    src="{{asset('build/assets/img/ecommerce/products/1.png')}}"
                                                    alt="product-img"
                                        ...
                                        <div class="ti-dropdown-item relative header-box">
                                            <a href="javascript:void(0);"
                                                class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                <img loading="lazy"
                                                    src="{{asset('build/assets/img/ecommerce/products/2.png')}}"
                                                    alt="product-img"
                                                    class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
                                                <div>
                                                    <p class="text-sm font-medium text-gray-800 dark:text-white">
                                        ...
                                        <div class="ti-dropdown-item relative header-box">
                                            <a href="javascript:void(0);"
                                                class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                <img loading="lazy"
                                                    src="{{asset('build/assets/img/ecommerce/products/9.png')}}"
                                                    alt="product-img"
                                                    class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
                                                <div>
                                                    <p class="text-sm font-medium text-gray-800 dark:text-white">
                                        ...
                                        <div class="ti-dropdown-item relative header-box">
                                            <a href="javascript:void(0);"
                                                class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                                                <img loading="lazy"
                                                    src="{{asset('build/assets/img/ecommerce/products/10.png')}}"
                                                    alt="product-img"
                                                    class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
                                                <div>
                                                    <p class="text-sm font-medium text-gray-800 dark:text-white">
                                    ...
                                    <div class="py-2 first:pt-0 last:pb-0" id="allNotifyContainer">
                                        <div class="ti-dropdown-item relative header-box">
                                            <a href="javascript:void(0);" class="flex space-x-3 rtl:space-x-reverse">
                                                <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                                                    <img src="{{asset('build/assets/img/users/17.jpg')}}" alt="img"
                                                        class="rounded-sm">
                                                </div>
                                        ...
                                        <div class="ti-dropdown-item relative header-box">
                                            <a href="javascript:void(0);"
                                                ...
                                                <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                                                    <img src="{{asset('build/assets/img/users/2.jpg')}}" alt="img"
                                                        class="rounded-sm">
                                                </div>
                                                <div class="relative w-full">
                                                    <h5
                                        ...
                                        <div class="ti-dropdown-item relative header-box">
                                            <a href="javascript:void(0);"
                                                class="flex items-center space-x-3 rtl:space-x-reverse">
                                                <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                                                    <img src="{{asset('build/assets/img/users/21.jpg')}}" alt="img"
                                                        class="rounded-sm">
                                                </div>
                                                <div class="relative w-full">
                                                    <h5
                                        ...
                                        <div class="ti-dropdown-item relative header-box">
                                            <a href="javascript:void(0);"
                                                class="flex items-center space-x-3 rtl:space-x-reverse">
                                                <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                                                    <img src="{{asset('build/assets/img/users/11.jpg')}}" alt="img"
                                                        class="rounded-sm">
                                                </div>
                                                <div class="relative w-full">
                                                    <h5
                                                        class="text-sm text-gray-800 dark:text-white font-semibold mb-1">
                                                        Charlie Davieson</h5>
                                                    <p class="text-xs mb-1 max-w-[200px] truncate">Lorem ipsum dolor sit
                                                        amet, consectetur</p>
                                                    <p class="text-xs text-gray-400 dark:text-white/70">yesterday</p>
                                                </div>
                                            </a>
                                ...
                                <div class="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                                    <div class="grid grid-cols-3 gap-0 p-4 pt-2">
                                        ...
                                        <a href="javascript:void(0);"
                                            ...
                                            <div class="text-xs font-semibold text-gray-800 dark:text-white">FileManager
                                            </div>
                                        </a>
                                        <a href="javascript:void(0);"
                                            class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
